...
const Header = () => {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 w-full bg-[#fff6df] shadow-sm">
        <div className="max-w-6xl mx-auto px-6 lg:px-10">
          <div className="flex h-20 items-center justify-between">
            ...
            <div className="hidden lg:flex items-center justify-end w-[220px] shrink-0">
              <a
                href="/contact"
                className="whitespace-nowrap rounded-full bg-[#cf361b] px-5 py-2 text-sm font-semibold text-white shadow-md transition hover:bg-[#af1d18] hover:scale-105"
              >
                Contact Us
              </a>
            </div>
            ...
            >
              <AlignLeft className="h-6 w-6 text-[#c91515]" />
            </button>
            ...
            <div className="lg:hidden flex items-center">
              <a
                href="/contact"
                className="whitespace-nowrap rounded-full bg-[#cf361b] px-4 py-2 text-sm font-semibold text-white shadow-md transition hover:bg-[#af1d18]"
              >
                Contact Us
              </a>
            </div>
